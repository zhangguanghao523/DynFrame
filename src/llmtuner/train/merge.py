...
def merge_lora(
    ...
    processor.tokenizer.padding_side = "left"  # restore padding side
...
def parse_args():
    ...
    parser.add_argument('--base_model_path',
                        default="",
                        type=str, help='base model path before merge')
    parser.add_argument('--saved_thinker_path',
                        default="",
                        type=str, help='saved thinker path before merge')
    parser.add_argument('--lora_checkpoint_path',
                        default="",
                        type=str, help='lora checkpoint path before merge')
    parser.add_argument('--save_path',
                        default="",
                        type=str, help='local path of merged-model')
...
if __name__ == "__main__":
    ...
    if args.lora_checkpoint_path:
        merge_lora(base_model_path=base_model_path,
        lora_checkpoint_path=args.lora_checkpoint_path,
        save_path = args.save_path)
    elif args.saved_thinker_path:
        save_full_model(
        saved_thinker_path=args.saved_thinker_path,
        base_model_path=base_model_path,
        save_path = args.save_path)
    else:
        raise Exception("lora_adpater_path or saved_thinker_path must be set")