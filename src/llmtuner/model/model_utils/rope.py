...
def configure_rope(config: "PretrainedConfig", model_args: "ModelArguments", is_trainable: bool) -> None:
    ...
    rope_scaling = {"type": model_args.rope_scaling}
    if not is_trainable and model_args.rope_scaling == "yarn":
        rope_scaling["original_max_position_embeddings"] = config.max_position_embeddings
        scaling_factor = 4.0
    elif model_args.model_max_length is not None:
    ...
    rope_scaling["factor"] = scaling_factor
